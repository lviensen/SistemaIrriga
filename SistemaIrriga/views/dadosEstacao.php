                  ...
                  <div class="container">
                    ...
                    <table class="bordered">
                      ...
                      <?php
                        ...
                        $resultado = $dados->mostrarDados($_POST['id']);
                            ...
                            <tbody>
                              <tr>
                                <form method="post" action="./editarDados.php">
                                  ...
                                  <td><?php echo $data; ?></td>
                                  <td><button type="submit" id="botaoVisualizar"  class="secondary-content tooltipped " data-position="bottom" data-delay="50" data-tooltip="Ver Professores"><i class="material-icons orange-text">edit</i> </button></td>
                                </form>
                              </tr>
